        ...
        <div className="bg-white rounded-xl shadow-lg overflow-hidden">
                ...
                <div className="h-32 w-32 rounded-full border-4 border-white overflow-hidden bg-white shadow-lg">
                  <img
                    ...
                    onError={(e) => {
                      ...
                      e.target.src = 'https://ui-avatars.com/api/?name=' + data.firstName + '+' + data.lastName + '&background=0D8ABC&color=fff';
                    }}
                  />
                </div>
              </div>
          ...
          <div className="p-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="space-y-4">
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="font-medium text-gray-800">{data.enrollmentNo}</p>
                    </div>
                  </div>
              ...
              <div>
                <h2 className="text-xl font-semibold text-gray-800 mb-4 border-b pb-2">Academic Information</h2>
                <div className="space-y-4">
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="font-medium text-gray-800">{data.branch}</p>
                    </div>
                  </div>
